          ...
          {isSuperAdmin && (
            <div className="bg-slate-50/50 p-5 rounded-2xl border border-slate-100 space-y-4">
              <div className="flex items-center gap-2 text-slate-800 border-b border-slate-100 pb-2">
                ...
                <h4 className="font-bold text-xs uppercase tracking-wide">Konfigurasi Integrasi Google Sheets</h4>
              </div>
              ...
              <div className="p-4 bg-emerald-50/40 rounded-xl border border-emerald-100/50 space-y-3 mt-2">
                <span className="font-bold text-xs text-emerald-900 block">Inisialisasi Cepat Google Sheets (Opsional)</span>
                ...
                <div className="flex flex-wrap items-center gap-3 pt-1">
                  {!googleUser ? (
                    <button
                      ...
                      className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-semibold text-xs px-4 py-2 rounded-xl flex items-center gap-2 cursor-pointer shadow-sm shadow-slate-100/50 transition-colors"
                    >
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                      <div className="text-xs font-semibold text-emerald-800 flex items-center gap-1.5 bg-white border border-emerald-200 px-3 py-2 rounded-xl">
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs px-4 py-2 rounded-xl flex items-center gap-1.5 cursor-pointer shadow-sm shadow-emerald-600/10 transition-colors"
                      >
