...
export default function DashboardView({
  ...
  const boyMurid = students.filter(s => s.jenis_kelamin === 'L').length;
  const girlMurid = students.filter(s => s.jenis_kelamin === 'P').length;
  ...
  const maleGuru = teachers.filter(t => t.jenis_kelamin === 'L').length;
  const femaleGuru = teachers.filter(t => t.jenis_kelamin === 'P').length;
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-panel rounded-3xl p-6 border border-white/60 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800 font-sans tracking-tight">
            Selamat datang, {user.name.includes('Super Admin') ? 'Super Admin' : user.name}!
          </h2>
      ...
      {/* Secondary Quick Statistics Sub-Panel */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl p-5 border border-slate-200/60 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wide font-sans">Laporan Masuk Bulanan</h3>
            <span className="text-[10px] text-slate-400 font-mono">Volume Laporan Bulanan</span>
          </div>
          <div className="h-64">
